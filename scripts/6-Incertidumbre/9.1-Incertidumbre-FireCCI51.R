...
# load("/mnt/disco6tb/Dropbox/UAH/FireCCI60/results/FireCCI60-2003-2022-CL30-R30-3/RData/BA_FireCCI60.RData")
...
# image.plot(BA_Fire51_tot[,,1])
# x=BA_Fire51_tot[,,193]
# y=BA_FireS3_tot[,,193]
# image.plot(lon, lat, x)
# image.plot(lon, lat, y)
...
image.plot(lon, lat, global_rmse_rel_full[,,13])
print(summary(as.vector(global_rmse_rel_full)))

image.plot(lon, lat, global_rmse_abs_full[,,13])
print(summary(as.vector(global_rmse_abs_full)))

outfile <- file.path(output_dir_RData, "BA_Incertidumbre_FireCCI51.RData")
